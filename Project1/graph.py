...
def loadEdgeList(anomymizedEdges):
    ...
    #print len(max([i for i in nx.connected_components(UG)],key=len))

    #print [i for i in nx.cycles.simple_cycles(G) if len(i)==3]
